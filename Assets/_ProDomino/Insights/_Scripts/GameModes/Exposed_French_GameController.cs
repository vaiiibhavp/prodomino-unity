...
{
    public class Exposed_French_GameController : ExposedGameController<French_GameMode>, IExposedGameController
    {
        public override double CalculateWinningProbability(bool isPlayer, VisibleInfo visibleInfo)
        {
        ...
        public override double CalculateBlockingProbability(VisibleInfo visibleInfo)
        {
        ...
        public override double CalculateTieProbability(VisibleInfo visibleInfo)
        {
            if (DeckController == null || HandController == null)
                throw new Exception("Required references not assigned");
            ...
            int myPlayable = visibleInfo.HasFlag(VisibleInfo.MyHand) ? CountPlayableMovesFrench(myHand, openBranches, requiredDoubles) : -1;
            int opponentPlayable = visibleInfo.HasFlag(VisibleInfo.OpponentHand) ? CountPlayableMovesFrench(opponentHand, openBranches, requiredDoubles) : -1;
        ...
        {
            var (left, right, top, down, doublesEnabled) = HandController.GetBranchNumbers();
