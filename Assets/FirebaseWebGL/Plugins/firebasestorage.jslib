mergeInto(LibraryManager.library, {
    ...
    UploadFile: function(path, data, objectName, callback, fallback) {
        ...
        try {
            ...
            firebaseApp.storage().ref(parsedPath).put(base64ToArrayBuffer(parsedData)).then(function(snapshot) {
    ...
    DownloadFile: function(path, objectName, callback, fallback) {
        ...
        try {
            ...
            firebaseApp.storage().ref(parsedPath).getDownloadURL().then(function(url) {
